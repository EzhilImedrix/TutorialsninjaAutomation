...
public class TC_RF_002 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("ap_email_login")).sendKeys("ezhilarasanezhil05@gmail.com");
		driver.findElement(By.xpath("//input[@type='submit']")).click();
		driver.findElement(By.xpath("//a[@id='auth-fpp-link-bottom']")).click();
		
		String email ="ezhilarasanezhil05@gmail.com";
		String apppasscode="ngry sscm ujiy evys";
